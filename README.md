Hi there, I'm Khalid Alao 

I'm a developer with an interest for cybersecurity and software engineering. I enjoy building secure, scalable systems and crafting intuitive user experiences. My projects range from network security labs and CLI tools to interactive web applications.

Tech & Tools

Cybersecurity & Infrastructure
nftables · Firewall · Network Security · Infrastructure · Bash · SQLite

Frontend
React · JavaScript · HTML5 · CSS3 · Framer Motion · REST APIs · Responsive Design

Backend / Tools
Spring Boot · PostgreSQL · Command Line · Database Design
